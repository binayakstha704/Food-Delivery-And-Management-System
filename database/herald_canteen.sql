-- ============================================================
-- Herald Canteen — Full Database
-- Fixed & cleaned for clean reimport on XAMPP / MariaDB 10.4+
-- Includes: all original tables + data + user_logs (SCRUM-49)
-- ============================================================
...
-- ============================================================
-- TABLE: login_attempts  (SCRUM-53: Rate Limiting)
-- ============================================================
CREATE TABLE `login_attempts` (
  ...
  -- Composite index: speeds up the COUNT + DELETE queries on every login
...
INSERT INTO `users` (`user_id`, `full_name`, `email`, `password`, `role`, `phone`, `is_active`, `mfa_enabled`, `email_verified_at`, `created_at`, `updated_at`) VALUES
(1, 'Test Customer',  'customer@heraldcanteen.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'customer', '9817456222', 1, 0, '2026-04-18 19:56:25', '2026-04-18 19:56:25', '2026-04-18 21:44:52'),
(2, 'Main Chef',      'chef@heraldcanteen.com',     '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'chef',     NULL,         1, 0, '2026-04-18 19:56:25', '2026-04-18 19:56:25', '2026-04-18 19:56:25'),
(3, 'Delivery Staff', 'staff@heraldcanteen.com',    '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'staff',    NULL,         1, 0, '2026-04-18 19:56:25', '2026-04-18 19:56:25', '2026-04-18 19:56:25'),
(4, '25 cr wasted',   'green@heraldcanteen.com',    '$2y$10$4W/.xgE8iuIdaPQxcqw69uXOHHo915Gk8JKdW0rGBKowgpHKFi2rm', 'customer', '9856784521', 1, 0, '2026-04-18 21:06:25', '2026-04-18 21:06:25', '2026-04-18 21:23:12');
...
-- ============================================================
-- TABLE: pending_registrations  (email verification queue)
-- ============================================================
...
-- ============================================================
-- TABLE: user_logs  (SCRUM-49: User Logs Monitoring)
-- ─────────────────────────────────────────────────────────────
-- Stores one row per trackable system event.
-- event_type covers: login_success, login_failed,
--                    logout, access_denied
-- user_id is nullable — failed logins may not have a known user.
-- Rows are written by log_user_event() in functions.php.
-- Viewable via pages/user-logs.php (chef and staff only).
-- ============================================================
CREATE TABLE `user_logs` (
  `log_id`      int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id`     int(10) UNSIGNED NULL DEFAULT NULL,
  `event_type`  enum('login_success','login_failed','logout','access_denied') NOT NULL,
  `ip_address`  varchar(45)      NOT NULL,
  `description` varchar(255)     NOT NULL DEFAULT '',
  `created_at`  datetime         NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`log_id`),
  KEY `idx_user_logs_event_type` (`event_type`),
...
-- (defined after all tables exist to avoid ordering errors)
-- ============================================================
...
ALTER TABLE `user_logs`
  ADD CONSTRAINT `fk_user_logs_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- ============================================================
-- AUTO_INCREMENT start values (preserves existing data gaps)
-- ============================================================
ALTER TABLE `cart`               MODIFY `cart_id`         int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
ALTER TABLE `categories`         MODIFY `category_id`     int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
ALTER TABLE `login_attempts`     MODIFY `attempt_id`      int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
ALTER TABLE `menu_items`         MODIFY `item_id`         int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
ALTER TABLE `notifications`      MODIFY `notification_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
ALTER TABLE `orders`             MODIFY `order_id`        int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
ALTER TABLE `order_items`        MODIFY `order_item_id`   int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
ALTER TABLE `payments`           MODIFY `payment_id`      int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
ALTER TABLE `users`              MODIFY `user_id`         int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
ALTER TABLE `otp_tokens`         MODIFY `otp_id`          int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
ALTER TABLE `pending_registrations` MODIFY `pending_id`   int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
ALTER TABLE `user_logs`          MODIFY `log_id`          int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
