            ...
            <section class="ops-panel" id="kot-section">
                <div class="ops-panel-heading">
                    <div>
                        ...
                        <p>Use these cards to move orders from pending to ready. Active (pending/preparing) and recently-ready KOTs are shown here so you can still print them. Completed tickets (delivered/cancelled) are hidden from this view.</p>
                    </div>
            ...
            <section class="ops-panel ops-dashboard-links">
                <div class="ops-panel-heading">
                    <div>
                        ...
                        <p>Menu, category, and delivery location management are on dedicated pages so this dashboard stays focused on kitchen work.</p>
                    </div>
                </div>
                <div class="ops-quick-link-grid">
                    ...
                    <a href="manage-delivery-locations.php" class="ops-quick-link"><span>📍</span><strong>Delivery Locations</strong><small>Manage delivery drop points.</small></a>
                </div>
            </section>
...
document.getElementById('deleteForm').addEventListener('submit', function(e) {
    ...
    .then(function(data) {
        ...
        if (data.ok) {
            ...
            hcAlert(data.error || 'Failed to delete item.', {icon:'❌', type:'danger'});
...
function updateOrderStatus(orderId, newStatus, btn) {
    ...
    .then(function(data) {
        if (!data.ok) {
            ...
            hcAlert(data.error || 'Failed to update order status.', {icon:'❌', type:'danger'});
            return;
        }
