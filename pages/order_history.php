...
<head>
    ...
    <style>
        ...
        html[data-theme="light"] .order-section-switch a { border-color:#e0e0e0 !important; background:#f7f7f7 !important; color:#333 !important; }
        html[data-theme="light"] .order-section-switch a.active { border-color:rgba(77,184,72,.5) !important; background:rgba(77,184,72,.08) !important; color:#1f6f43 !important; }
        html[data-theme="light"] .order-section-switch small { color:#555 !important; }
        html[data-theme="light"] .history-note { color:#333 !important; background:rgba(77,184,72,.06) !important; border-color:rgba(77,184,72,.2) !important; }
        html[data-theme="light"] .order-meta-pill { background:#f5f5f5 !important; border-color:#e0e0e0 !important; color:#444 !important; }
        html[data-theme="light"] .order-meta-pill strong { color:#1c1c1c !important; }
            ...
            <div class="card order-card">
                ...
                <?php if (($order['delivery_mode'] ?? 'delivery') === 'delivery'): ?>
                    <div class="order-delivery-location" style="margin-top:10px;padding:10px 12px;background:rgba(77,184,72,0.07);border:1px solid rgba(77,184,72,0.15);border-radius:8px;font-size:13px;">
                        <span style="color:rgba(255,255,255,0.5);font-size:11px;display:block;margin-bottom:3px;" class="dloc-label">📍 DELIVERY LOCATION</span>
