...
<head>
    ...
    <style>
        ...
        /* Light mode — full white invoice */
        html[data-theme="light"] body.invoice-standalone {
        ...
        html[data-theme="light"] .invoice-brand p { color: #555555 !important; }
        html[data-theme="light"] .invoice-meta p { color: #555555 !important; }
        html[data-theme="light"] .info-block p { color: #1c1c1c !important; }
        ...
        html[data-theme="light"] .invoice-footer {
            color: #777777 !important;
            border-top-color: #e0e0e0 !important;
        }
        html[data-theme="light"] .btn-invoice-outline {
