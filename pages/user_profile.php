...
<nav class="navbar">
    <a class="navbar-brand" href="index.php"><img src="../assets/images/Logo.PNG" alt="Herald Canteen" class="navbar-logo"><div class="navbar-title">Herald Canteen<span>Herald College Kathmandu</span></div></a>
    ...
    <div class="navbar-user"><label class="theme-toggle" title="Toggle light/dark mode"><input type="checkbox" class="theme-checkbox"><span class="theme-slider"></span></label></div>
</nav>
