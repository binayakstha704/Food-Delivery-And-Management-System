        ...
        <div class="notif-list">
            ...
            <div class="notif-card">
                ...
                <div class="notif-card-body">
                    <div class="notif-card-title"><?php echo htmlspecialchars($n['title'], ENT_QUOTES, 'UTF-8'); ?></div>
                    <div class="notif-card-msg"><?php echo htmlspecialchars($n['message'], ENT_QUOTES, 'UTF-8'); ?></div>
