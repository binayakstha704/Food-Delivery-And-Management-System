...
<script src="../assets/js/theme.js"></script>
    ...
    <style>
        ...
        html[data-theme="light"] .back-link { color: #333333 !important; }
        html[data-theme="light"] .btn-clear-all { border-color:rgba(0,0,0,0.18) !important; color:#444 !important; }
        html[data-theme="light"] .notif-card { background:#ffffff !important; border-color:#e0e0e0 !important; }
        html[data-theme="light"] .notif-card-title { color:#1c1c1c !important; }
        html[data-theme="light"] .notif-card-msg { color:#555555 !important; }
        html[data-theme="light"] .notif-card-time { color:#888888 !important; }
        html[data-theme="light"] .notif-card-del { color:#aaaaaa !important; }
        html[data-theme="light"] .notif-empty { color:#999999 !important; }
    </style>
</head>
<body class="notifications-page">
    ...
    <div class="notif-page-wrap">
        ...
        <div class="notif-page-header">
            ...
            <form method="POST" data-hc-confirm="Clear all notifications?" data-hc-confirm-icon="🔔" data-hc-confirm-ok="Clear All">
